...
export const employeeRequests: EmployeeRequest[] = [
        ...
        { id: 3, date: '2024-01-03T11:00:00Z', customerId: 1, employeeId: 3, requestType: 'bathroom maintenance', requestStatus: 'pending' },
        ...
        { id: 13, date: '2024-01-13T11:00:00Z', customerId: 6, employeeId: 2, requestType: 'tv maintenance', requestStatus: 'done' },
        { id: 14, date: '2024-01-14T12:00:00Z', customerId: 6, employeeId: 4, requestType: 'bathroom maintenance', requestStatus: 'progress' },
        { id: 15, date: '2024-01-15T13:00:00Z', customerId: 6, employeeId: 5, requestType: 'cleaning', requestStatus: 'pending' }
      ];
